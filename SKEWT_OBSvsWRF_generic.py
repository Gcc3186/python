...
skew.plot(pressure[::3,jj,ii], td[::3,jj,ii], 'r',linestyle='--',label='')
skew.plot(pressure[::3,jj,ii], tc[::3,jj,ii], 'r',label='WRF')
skew.plot_barbs(to_np(pressure[::5,jj,ii]),to_np(ms_to_kt(ua[::5,jj,ii])),to_np(ms_to_kt(va[::5,jj,ii])),y_clip_radius=0.03,color='r')
plt.ylabel('values')
